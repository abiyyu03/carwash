...
use App\Models\{Customer, VehicleType, Transaction, TransactionDetail, Product, ProductCategory};
use Lava;
use DataTables;
...
class DashboardController extends Controller
{
    function index()
    {
        ...
        $categoryProduct_data = $this->getProductCategory();
        return view('dashboard.index',compact('transaction_data','transactionPending_data','product_data','categoryProduct_data'));
    }
